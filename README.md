...
Блок с расчетом различных показателей для каждого курса(кол-во курсов и учеников, кол-во модулей и др.), очистка данных от ошибок, расчет потенциальной нагрузки на преподавателей для оценки необходимости расширения штата сотрудников, анализ качества контента курсов, где необходимо выявить проблемные для студентов модули, требующие доработки, выявление сезонности образовательных программ .
